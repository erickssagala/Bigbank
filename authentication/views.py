...
def home(request):
    return render(request, "authentication/newHomePage.html")
...
def signup(request):
    if request.method == "POST":
        ...
        if len(username)>18 or len(username)<6:
        ...
        messages.success(request, "Account successfully created! We have sent you a confirmation link, check your email to activate account")
